    ...
    socket.on('connect', function() {
        ...
        socket.emit('auth', authRequest, function(err, authResponse) {
            ...
            if(access_token!="" && access_token!=null){
                ...
                $.getJSON("https://api.moneypot.com/v1/list-bets?access_token="+access_token+"&app_id=1322&wager=500000&limit=11&order_by=desc", function(json){
...
$('#moneypotDepositButton').click(function() {
    var windowUrl = 'https://www.moneypot.com/dialog/deposit?app_id=1322';
...
$('#withdrawButton').click(function() {
    var windowUrl = 'https://www.moneypot.com/dialog/withdraw?app_id=1322';
    var windowName = 'manage-auth';
    var windowOpts = 'width=420,height=350,left=100,top=100';
    var windowRef = window.open(windowUrl, windowName, windowOpts);
    windowRef.focus();
...
function startNewGame(){
    if(!connected){
        $('#theDimmer').html("Error: Not connected!<br><a href=\"https://www.moneypot.com/oauth/authorize?app_id=1322&response_type=token&state=Meh&redirect_uri=http://bitmine.ml/">Click here to login</a>");
