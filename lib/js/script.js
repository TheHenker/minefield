...
function startNewGame(){
    ...
    $.post("https://api.moneypot.com/v1/hashes?access_token="+access_token, '', function(json) {
        ...
        if(Hash == "" || Hash == false){
            $('#theDimmer').html("Error: Not connected!<br><a href=\"https://www.moneypot.com/oauth/authorize?app_id=1115&response_type=token&state=Meh&redirect_uri=http://mines.bitcoinshare\">Click here to login</a>");
            $('#game_left').dimmer('show');
