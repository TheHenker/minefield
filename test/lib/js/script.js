...
$(function(){
    ...
    if(getURLParameter('access_token')!="" && getURLParameter('access_token')!=null){
        ...
        window.history.pushState('', 'BitcoinShare', '/');
    }
...
function startNewGame(){
    if(!connected){
        $('#theDimmer').html("Error: Not connected!<br><a href=\"https://www.moneypot.com/oauth/authorize?app_id=1256&response_type=token&state=Meh&redirect_uri=http://mines.bitcoinshare.xyz/test/\">Click here to login</a>");
